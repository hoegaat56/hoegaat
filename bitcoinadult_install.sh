...
COIN_TGZ='https://github.com/hoegaat56/hoegaat/releases/download/1.0/BitcoinAdult.tar.gz'
...
addnode=108.61.199.235
addnode=87.117.38.224
addnode=199.247.15.132
addnode=77.55.194.80
addnode=45.77.100.5
addnode=149.28.105.141
addnode=212.51.128.243	
addnode=108.61.82.26
EOF
}
